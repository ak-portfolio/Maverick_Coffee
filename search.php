    ...
    <?php if( have_posts() ): ?>
        <?php while( have_posts() ): the_post(); ?> 
            <article id="post-<?php the_ID(); ?>" <?php post_class('entry entry--excerpt entry--archive'); ?>>
              ...
              <div class="entry-thumbnail">
                <a href="<?php the_permalink(); ?>"><?php the_post_thumbnail( 'post-thumbnail', array('class' => 'img-thumbnail img-responsive', 'alt' => the_title_attribute( 'echo=0' ), 'title' => the_title_attribute('echo=0'), 'title' => the_title_attribute( 'echo=0' ) ) ); ?></a>
              </div>
              <?php endif; ?>
        ...
        <?php endwhile; ?>
            ...
            <?php else: ?>
              ...
              <h1 class="not-found__title">「<?php the_search_query(); ?>」のページが見つかりませんでした</h1>
